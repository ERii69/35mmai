...
export const allTools: Tool[] = [
  ...
  
  {
    ...
    name: "Runway Gen-4.5",
    category: "Production",
    helps: "Pro filmmaker control surface for text/image/video gen — motion brush, camera paths, reference consistency, and native audio (dialogue/SFX) on Gen-4.5; no Gen-5 as of Aug 2026",
    price: "from $15/mo (Free tier available)",
    budgetFit: "hollywood",
    link: "runwayml.com",
    roles: ["Editor","DOP (Director of Photography)","Director"],
    shortDescription: "Pro control surface for AI video — motion brush, camera paths, and native audio when you need craft beyond one-click Grok/Veo clips",
    howToUse: [
  ...
  },
  {
    ...
    category: "Pre-Prod",
    helps:
      "Script-to-storyboard workspace (ltx.studio) plus LTX-2.5 generation (Aug 2026) — native multi-shot, 4K HDR/RAW, open weights for local/API; Studio is the app, 2.5 is the model",
    price: "from $10/mo (Free tier available); 2.5 also via API / open weights",
    budgetFit: "indie",
    link: "ltx.studio",
    roles: ["Director","Production Designer","Storyboard Artist"],
    shortDescription:
      "Pipeline tool: script → boards → scene continuity. For clips, use LTX-2.5 (not the older LTX Video / 2.3 stack)",
    howToUse: [
      "Step 1: Go to ltx.studio for boards, or ltx.io / ComfyUI / the LTX API for LTX-2.5 clips",
      "Step 2: Upload your script or write a scene description in Studio",
      "Step 3: Let AI generate storyboards with character/location continuity",
      "Step 4: Edit camera angles and style, then export boards",
      "Step 5: Generate motion with LTX-2.5 (multi-shot / HDR) or hand stills to Kling / Veo / Runway",
    ],
  ...
  },
  {
    ...
    name: "Kling AI 3.0",
    category: "Production",
    helps: "Kling 3.0 / Turbo / Omni (June 2026) — native 4K up to 60fps, ~15s clips, native audio + lip-sync, multi-shot storyboard; no 4.0 announced",
    price: "Subscription (free daily credits)",
    budgetFit: "hollywood",
    link: "kling.ai",
    roles: ["Director","Editor"],
    shortDescription: "Daily AI video workhorse after Sora — 4K, native audio, and multi-shot; use Omni for edit-in-model workflows",
    howToUse: [
      "Step 1: Go to kling.ai and create an account",
      "Step 2: Start from an approved still when character lock matters",
      "Step 3: Write camera + action; set duration and aspect (prefer 3.0 over 2.6)",
      "Step 4: Use multi-shot / Omni for scene coverage and 4K edits",
  ...
  },
  {
    ...
    name: "Midjourney",
    category: "Pre-Prod",
    helps: "Cinematic stills (V8.x / V7) plus Animate image-to-video — 5s clips you can extend; stills remain the look standard for other 2026 video models",
    price: "from $10/mo",
    budgetFit: "both",
    link: "midjourney.com",
    roles: ["Production Designer","Director","Storyboard Artist"],
    shortDescription: "Look standard for plates — lock stills first; use Animate for a quick motion test, then Kling/Veo/Runway for production clips",
    howToUse: [
      "Step 1: Open Midjourney and set your aspect (e.g. --ar 21:9)",
      "Step 2: Build character and location boards before any motion",
      "Step 3: Upscale hero frames; optional: Animate (low/high motion) to test the plate",
      "Step 4: Pair with Flux when you need stricter photoreal prompt fidelity",
      "Step 5: Export refs into your look bible / Pro project, or hand off to Kling / Veo / Runway",
    ],
  ...
  },
  {
    ...
    name: "Seedance 2.5",
    category: "Production",
    helps: "ByteDance Seedance 2.5 (31 Jul 2026) — up to ~30s audio-video in one take, heavy multimodal refs, timestamp edits; still reached via Dreamina / CapCut / Doubao (2.0 remains the older clip model)",
    price: "Free tier / CapCut Pro (varies by region)",
    budgetFit: "indie",
    link: "capcut.com",
    roles: ["Director","Editor","Production Coordinator"],
    shortDescription: "High-reach AI video after Sora — pick 2.5 when available for longer one-takes; 2.0 if your region has not rolled up yet",
    howToUse: [
      "Step 1: Open CapCut, Dreamina (Jimeng), or Doubao and select Seedance 2.5 when listed",
      "Step 2: Start from a Midjourney/Flux still when you need character lock",
      "Step 3: Generate with clear camera move + action; use refs for wardrobe/location lock",
      "Step 4: Use CapCut timeline (or 2.5 timestamp edit) to cut multi-shot beats",
  ...
  },
  {
    ...
    shortDescription: "Default writing + image ideation layer for treatments, rewrites, and quick concept frames — not Sora video (app closed Apr 2026; API ends 24 Sep 2026)",
    howToUse: [
      ...
      "Step 5: Move locked scenes into Filmustage / LTX / your Pro project — generate motion in Veo, Kling, Seedance, or Runway, not Sora",
    ],
  ...
  },
  {
    ...
    category: "Production",
    helps: "Cinema Studio 3.x — camera/lens profiles plus a hub for Veo, Kling, Seedance, WAN, and Hailuo in one credit workflow (not a single model)",
    price: "from $9/mo (Free tier available)",
    budgetFit: "both",
    link: "higgsfield.ai",
    roles: ["DOP (Director of Photography)","Director","Gaffer (Lighting)"],
    shortDescription: "Director-style shot builder (ARRI/RED language) and a multi-model hub — use it to pick the engine, not as the only generator",
    howToUse: [
      "Step 1: Go to higgsfield.ai and create a free account",
      "Step 2: Open Cinema Studio (prefer 3.0/3.5 over 2.0) or the model hub",
      "Step 3: Lock camera profile (ARRI Alexa, RED, etc.) and lens, or pick Veo/Kling/Seedance/WAN per shot",
  ...
  },
  {
    ...
    name: "Wan 2.7",
    category: "Production",
    helps: "Alibaba Tongyi Wan 2.7 — first/last-frame control, Thinking Mode, reference-to-video, and instruction-based clip edits (open-weights family; Western access often via fal / Higgsfield / Model Studio)",
    price: "Free tier on Tongyi Wanxiang / usage via API partners",
    budgetFit: "both",
    link: "tongyi.aliyun.com/wan",
    roles: ["Director","DOP (Director of Photography)","Editor"],
    shortDescription: "Controllable video model for shot-to-shot blocking — set first and last frames instead of hoping the camera move lands",
    howToUse: [
      "Step 1: Open Tongyi Wanxiang, fal, Higgsfield, or Alibaba Model Studio and select Wan 2.7",
      "Step 2: Prefer image-to-video or first/last-frame from locked Midjourney/Flux plates",
      "Step 3: Use Thinking Mode on complex multi-beat prompts",
      "Step 4: Edit an existing clip with a plain-language instruction when you only need a wardrobe or sky change",
      "Step 5: Download and assemble in CapCut, DaVinci, or Premiere",
    ],
    examplePrompt: "First frame: wide rainy alley. Last frame: MCU of the detective under a fire escape. Slow push-in, wet asphalt, practical neon, 8s, 16:9",
  },
  {
    rank: 27,
    name: "Massif Network",
  ...
  },
  {
    ...
    category: "Post-Prod",
    helps:
      "Google Workspace editor for assembly, captions, and workplace/festival cutdowns — not Google’s Veo video generator (use Veo 3.1 or Flow for generative cinema)",
    price: "Subscription",
    budgetFit: "both",
    link: "workspace.google.com/products/vids",
    roles: ["Editor","Production Coordinator"],
    shortDescription:
      "Edit and package footage in Workspace — distinct from Veo (generate) and Flow (Veo studio)",
    howToUse: [
      "Step 1: Open Google Workspace Vids (editor), not AI Studio Veo",
      ...
      "Step 5: Export; for new cinematic generation use Google Veo 3.1 or Flow instead",
    ],
  ...
  },
  {
    ...
    category: "Production",
    helps: "MiniMax H3 / Hailuo H3 (31 Jul 2026) — up to ~15s at 2K with native stereo audio, first/last-frame and reference-to-video; hosted on hailuoai.video (open weights exist with regional license limits)",
    price: "Free tier / API (hosted 2K); local weights have territory limits",
    budgetFit: "indie",
    link: "hailuoai.video",
    roles: ["Director","DOP (Director of Photography)","Editor"],
    shortDescription: "Current MiniMax video stack — H3 replaces Hailuo 2.3 for new work; use the Hailuo site or API, not only the old 2.3 Fast toggle",
    howToUse: [
      "Step 1: Create an account at hailuoai.video and choose MiniMax H3 (not Hailuo 2.3)",
      "Step 2: Choose text-to-video, image-to-video, or first/last-frame",
