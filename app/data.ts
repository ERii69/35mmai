...
export const allTools: Tool[] = [
  ...
  },
  {
    ...
    category: "Pre-Prod",
    helps:
      "Script-to-storyboard pipeline for multi-scene continuity — Lightricks’ production workspace (not the open-source LTX Video model alone)",
    price: "from $10/mo (Free tier available)",
    budgetFit: "indie",
    link: "ltx.studio",
    roles: ["Director","Production Designer","Storyboard Artist"],
    shortDescription:
      "Pipeline tool: script → boards → scene continuity. Distinct from raw LTX Video open-source generation",
    howToUse: [
      "Step 1: Go to ltx.studio and sign up (this is the Studio app, not a raw model host)",
      ...
      "Step 5: Hand stills to Kling / Veo / Runway for motion if you need finished clips",
    ],
  ...
  },
  {
    ...
    category: "Production",
    helps:
      "Luma’s Ray / Dream Machine video generator — cinematic image-to-video with strong lighting, depth, and camera feel (the one Luma entry for generating clips)",
    price: "Subscription",
    budgetFit: "both",
    link: "lumalabs.ai/dream-machine",
    roles: ["Director","Editor"],
    shortDescription:
      "Primary Luma video tool (Ray / Dream Machine) — generate clips from stills or text; not the Relight companion",
    howToUse: [
  ...
  },
  {
    ...
    category: "Post-Prod",
    helps:
      "Companion to Luma Dream Machine — relight existing footage only (not a second text-to-video generator)",
    price: "Subscription",
    budgetFit: "both",
    link: "lumalabs.ai/ray",
    roles: ["Gaffer (Lighting)","DOP (Director of Photography)"],
    shortDescription:
      "Post tool: change lighting on plates you already have — use Dream Machine when you need new clips",
    howToUse: [
      "Step 1: Go to lumalabs.ai/ray (Relight) — not Dream Machine generate",
