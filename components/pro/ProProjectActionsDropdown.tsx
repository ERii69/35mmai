...
import { Archive, MoreVertical, Pencil, Star, Trash2 } from "lucide-react";
...
export function ProProjectActionsDropdown({
  projectName,
  isDefault,
  pending,
  onRename,
      ...
      ? createPortal(
          ...
          >
            ...
            <div className="border-t border-white/[0.06] p-1">
              ...
              >
                <Pencil className="size-4 text-pro-text-secondary" aria-hidden />
                Rename
              </button>
              {!isDefault && onMakeDefault ? (
                ...
                >
                  <Star className="size-4 text-pro-text-secondary" aria-hidden />
                  Make default
                </button>
              ) : null}
              <button
